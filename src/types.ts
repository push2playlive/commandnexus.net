...
export type TabCategory = 'THREAT SCAN' | 'INTEL MAP' | 'USER FEEDBACK' | 'AGENT COMMAND' | 'DIAGNOSTICS' | 'UTUBECHAT MARKET' | 'SHELL CONFIG' | 'SECURITY PULSE' | 'WALLET' | 'MARKET' | 'PRICING' | 'PROFILE' | 'SETTINGS' | 'VAULT' | 'UPTIME MONITOR' | 'EXECUTIVE SUITE';
